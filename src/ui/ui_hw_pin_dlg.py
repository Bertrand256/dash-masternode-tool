...
class Ui_HardwareWalletPinDlg(object):
    def setupUi(self, HardwareWalletPinDlg):
        ...
        self.layoutConfirmation = QtWidgets.QHBoxLayout()
        self.layoutConfirmation.setContentsMargins(-1, 4, -1, -1)
        self.layoutConfirmation.setObjectName("layoutConfirmation")
        spacerItem2 = QtWidgets.QSpacerItem(0, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.layoutConfirmation.addItem(spacerItem2)
        ...
        self.layoutConfirmation.addWidget(self.btnEnterPin)
        spacerItem3 = QtWidgets.QSpacerItem(0, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.layoutConfirmation.addItem(spacerItem3)
        self.verticalLayout.addLayout(self.layoutConfirmation)
