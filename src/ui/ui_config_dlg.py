...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.lblOpenLogFile = QtWidgets.QLabel(self.tabMisc)
        self.lblOpenLogFile.setText("")
        self.lblOpenLogFile.setOpenExternalLinks(True)
        self.lblOpenLogFile.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextBrowserInteraction|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        self.lblOpenLogFile.setObjectName("lblOpenLogFile")
        self.hlLogLevel.addWidget(self.lblOpenLogFile)
