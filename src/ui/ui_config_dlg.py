...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.edtVoteTimeOffsetLower = QtWidgets.QSpinBox(self.tabMisc)
        self.edtVoteTimeOffsetLower.setMinimumSize(QtCore.QSize(80, 0))
        self.edtVoteTimeOffsetLower.setMinimum(-720)
        self.edtVoteTimeOffsetLower.setMaximum(720)
        self.edtVoteTimeOffsetLower.setObjectName("edtVoteTimeOffsetLower")
        self.horizontalLayout_4.addWidget(self.edtVoteTimeOffsetLower)
        self.label_5 = QtWidgets.QLabel(self.tabMisc)
        ...
        self.label_4 = QtWidgets.QLabel(self.tabMisc)
        self.label_4.setObjectName("label_4")
        self.horizontalLayout_5.addWidget(self.label_4)
        self.edtVoteTimeOffsetUpper = QtWidgets.QSpinBox(self.tabMisc)
        self.edtVoteTimeOffsetUpper.setMinimumSize(QtCore.QSize(80, 0))
        self.edtVoteTimeOffsetUpper.setMinimum(-720)
        self.edtVoteTimeOffsetUpper.setMaximum(720)
        self.edtVoteTimeOffsetUpper.setObjectName("edtVoteTimeOffsetUpper")
        self.horizontalLayout_5.addWidget(self.edtVoteTimeOffsetUpper)
        self.label_6 = QtWidgets.QLabel(self.tabMisc)
        ...
        self.hlDustThreshold = QtWidgets.QHBoxLayout()
        self.hlDustThreshold.setObjectName("hlDustThreshold")
        self.lblDustThreshold = QtWidgets.QLabel(self.tabMisc)
        self.lblDustThreshold.setObjectName("lblDustThreshold")
        self.hlDustThreshold.addWidget(self.lblDustThreshold)
        self.edtDustThreshold = QtWidgets.QDoubleSpinBox(self.tabMisc)
        self.edtDustThreshold.setDecimals(8)
        self.edtDustThreshold.setSingleStep(1e-05)
        self.edtDustThreshold.setObjectName("edtDustThreshold")
        self.hlDustThreshold.addWidget(self.edtDustThreshold)
        self.lblDustThresholdUnit = QtWidgets.QLabel(self.tabMisc)
        self.lblDustThresholdUnit.setObjectName("lblDustThresholdUnit")
        self.hlDustThreshold.addWidget(self.lblDustThresholdUnit)
        spacerItem7 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.hlDustThreshold.addItem(spacerItem7)
        self.verticalLayout_2.addLayout(self.hlDustThreshold)
        ...
        self.hlLogLevel.addItem(spacerItem8)
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.chbShowDashFIATValue.setText(_translate("ConfigDlg", "Show DASH value in FIAT"))
        ...
        self.lblDustThreshold.setText(_translate("ConfigDlg", "Dust threshold:"))
        self.lblDustThresholdUnit.setText(_translate("ConfigDlg", "DASH"))
