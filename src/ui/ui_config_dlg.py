...
class Ui_ConfigDlg(object):
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.chbHwLedgerNanoS.setText(_translate("ConfigDlg", "Ledger Nano S (starting MN only)"))
        ...
        self.chbConfirmWhenVoting.setText(_translate("ConfigDlg", "Ask for confirmation when voting"))
        self.chbAddRandomOffsetToVotingTime.setText(_translate("ConfigDlg", "Add random offset to new vote time to enhance privacy"))
