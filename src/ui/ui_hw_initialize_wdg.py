...
class Ui_WdgInitializeHw(object):
    def setupUi(self, WdgInitializeHw):
        ...
        self.checkBox_2 = QtWidgets.QCheckBox(self.page1)
    ...
    def retranslateUi(self, WdgInitializeHw):
        ...
        self.checkBox.setText(_translate("WdgInitializeHw", "Use PIN"))
        self.checkBox_2.setText(_translate("WdgInitializeHw", "Use Passphrase"))
