...
class Ui_HwInitializeDlg(object):
    ...
    def retranslateUi(self, HwInitializeDlg):
        ...
        self.lblStep0Title_2.setText(_translate("HwInitializeDlg", "<b>Select device type</b>"))
        ...
        self.lblStep1Title.setText(_translate("HwInitializeDlg", "<b>Select the action to perform</b>"))
