...
class Ui_HwInitializeDlg(object):
    def setupUi(self, HwInitializeDlg):
        ...
        HwInitializeDlg.resize(598, 420)
        ...
        self.lblStep0Title_2 = QtWidgets.QLabel(self.pgStepDeviceType)
        self.lblStep0Title_2.setObjectName("lblStep0Title_2")
        self.verticalLayout_12.addWidget(self.lblStep0Title_2)
        ...
        self.lblStep1Title = QtWidgets.QLabel(self.pgStepActionType)
        self.lblStep1Title.setWordWrap(True)
        self.lblStep1Title.setObjectName("lblStep1Title")
        self.verticalLayout_5.addWidget(self.lblStep1Title)
        ...
        self.pgStepWordCountEntropy = QtWidgets.QWidget()
        self.pgStepWordCountEntropy.setObjectName("pgStepWordCountEntropy")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.pgStepWordCountEntropy)
        self.verticalLayout_6.setContentsMargins(6, 6, 6, 6)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.lblStep1MnemonicWords = QtWidgets.QLabel(self.pgStepWordCountEntropy)
        ...
        self.gbNumberOfMnemonicWords = QtWidgets.QGroupBox(self.pgStepWordCountEntropy)
        ...
        self.lblStep1HexEntropy = QtWidgets.QLabel(self.pgStepWordCountEntropy)
        self.lblStep1HexEntropy.setObjectName("lblStep1HexEntropy")
        self.verticalLayout_6.addWidget(self.lblStep1HexEntropy)
        self.edtHexEntropy = QtWidgets.QLineEdit(self.pgStepWordCountEntropy)
        self.edtHexEntropy.setObjectName("edtHexEntropy")
        self.verticalLayout_6.addWidget(self.edtHexEntropy)
        self.lblStep1Message1 = QtWidgets.QLabel(self.pgStepWordCountEntropy)
        self.lblStep1Message1.setText("")
        self.lblStep1Message1.setWordWrap(True)
        self.lblStep1Message1.setOpenExternalLinks(True)
        self.lblStep1Message1.setObjectName("lblStep1Message1")
        self.verticalLayout_6.addWidget(self.lblStep1Message1)
        self.lblStep1Message2 = QtWidgets.QLabel(self.pgStepWordCountEntropy)
        self.lblStep1Message2.setText("")
        self.lblStep1Message2.setObjectName("lblStep1Message2")
        self.verticalLayout_6.addWidget(self.lblStep1Message2)
        spacerItem3 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_6.addItem(spacerItem3)
        self.tabSteps.addWidget(self.pgStepWordCountEntropy)
        ...
        self.tabSteps.setCurrentIndex(5)
    ...
    def retranslateUi(self, HwInitializeDlg):
        ...
        self.lblStep0Title_2.setText(_translate("HwInitializeDlg", "<b>Select the device type</b>"))
        ...
        self.lblStepDeviceInstanceMessage.setText(_translate("HwInitializeDlg", "<b>Select which device you are going to use.</b>"))
        self.lblStep1Title.setText(_translate("HwInitializeDlg", "<b>Choose the action you are going to perform</b>"))
        self.rbActRecoverWordsSafe.setText(_translate("HwInitializeDlg", "Recover hardware wallet from words seed - safe"))
        self.rbActRecoverMnemonicWords.setText(_translate("HwInitializeDlg", "Recover hardware wallet from words seed - convenient"))
        self.rbActRecoverHexEntropy.setText(_translate("HwInitializeDlg", "Recover hardware wallet from hexadecimal entropy"))
        self.rbActInitializeNewSeed.setText(_translate("HwInitializeDlg", "Initialize hardware wallet with newly generated word seed"))
        ...
        self.lblStep1HexEntropy.setText(_translate("HwInitializeDlg", "<b>Enter the recovery entropy</b>"))
        self.edtHexEntropy.setPlaceholderText(_translate("HwInitializeDlg", "32/24/16-byte hexadecimal string"))
        self.lblStepWordListTitle.setText(_translate("HwInitializeDlg", "<b>Enter your recovery seed words</b>"))
        self.lblStepWordListMessage2.setText(_translate("HwInitializeDlg", "You can use your OS\'s stadard \'Copy\'/\'Paste\' shortcuts to copy/paste the whole words seed (separated with spaces/commas) from/to the editor."))
        ...
        self.edtHwOptionsDeviceLabel.setPlaceholderText(_translate("HwInitializeDlg", "Label for Trezor/Keepkey device"))
        ...
        self.edtHwOptionsLedgerSecondaryPIN.setPlaceholderText(_translate("HwInitializeDlg", "PIN for passphrase"))
