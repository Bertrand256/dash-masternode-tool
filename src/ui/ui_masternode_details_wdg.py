...
class Ui_WdgMasternodeDetails(object):
    ...
    def retranslateUi(self, WdgMasternodeDetails):
        ...
        self.btnGetPlatformNodeIdFromPrivate.setToolTip(_translate("WdgMasternodeDetails", "Get Platform Node ID from ED25519 private key"))
        self.btnGetPlatformNodeIdFromPrivate.setText(_translate("WdgMasternodeDetails", "Get from private"))
