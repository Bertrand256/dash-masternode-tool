...
class Ui_WdgMasternodeDetails(object):
    def setupUi(self, WdgMasternodeDetails):
        ...
        WdgMasternodeDetails.resize(741, 378)
        ...
        self.btnGeneratePlatformNodeId = QtWidgets.QToolButton(self.widget_2)
        self.btnGeneratePlatformNodeId.setObjectName("btnGeneratePlatformNodeId")
        self.horizontalLayout_11.addWidget(self.btnGeneratePlatformNodeId)
    ...
    def retranslateUi(self, WdgMasternodeDetails):
        ...
        self.btnGeneratePlatformNodeId.setToolTip(_translate("WdgMasternodeDetails", "Generate a new Platform Node ID"))
        self.btnGeneratePlatformNodeId.setText(_translate("WdgMasternodeDetails", "Generate new"))
