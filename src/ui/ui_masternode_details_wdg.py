...
class Ui_WdgMasternodeDetails(object):
    def setupUi(self, WdgMasternodeDetails):
        ...
        WdgMasternodeDetails.resize(700, 433)
        ...
        self.horizontalLayout_11.addWidget(self.edtPlatformNodeKey)
        ...
        self.horizontalLayout_11.addWidget(self.btnCopyPlatformNodeKey)
        ...
        self.horizontalLayout_11.addWidget(self.btnShowPlatformNodeKey)
        ...
        self.horizontalLayout_11.addWidget(self.btnGeneratePlatformNodePrivateKey)
    ...
    def retranslateUi(self, WdgMasternodeDetails):
        ...
        self.btnGeneratePlatformNodePrivateKey.setToolTip(_translate("WdgMasternodeDetails", "Set Platform Node ID from Ed25519 private key"))
