...
class Ui_WdgMasternodeDetails(object):
    def setupUi(self, WdgMasternodeDetails):
        ...
        WdgMasternodeDetails.resize(784, 406)
        ...
        self.lblMasternodeType.setMinimumSize(QtCore.QSize(144, 0))
        ...
        self.lblPlatformNodeId = QtWidgets.QLabel(self.widget_2)
        self.lblPlatformNodeId.setMinimumSize(QtCore.QSize(144, 0))
        ...
        self.horizontalLayout_11.addWidget(self.lblPlatformNodeId)
        self.edtPlatformNodeId = QtWidgets.QLineEdit(self.widget_2)
        self.edtPlatformNodeId.setEchoMode(QtWidgets.QLineEdit.Normal)
        self.edtPlatformNodeId.setClearButtonEnabled(True)
        self.edtPlatformNodeId.setObjectName("edtPlatformNodeId")
        self.horizontalLayout_11.addWidget(self.edtPlatformNodeId)
        self.btnCopyPlatformId = QtWidgets.QToolButton(self.widget_2)
        self.btnCopyPlatformId.setMaximumSize(QtCore.QSize(16777215, 21))
        self.btnCopyPlatformId.setText("")
        self.btnCopyPlatformId.setPopupMode(QtWidgets.QToolButton.MenuButtonPopup)
        self.btnCopyPlatformId.setObjectName("btnCopyPlatformId")
        self.horizontalLayout_11.addWidget(self.btnCopyPlatformId)
        self.btnGetPlatformNodeIdFromPrivate = QtWidgets.QToolButton(self.widget_2)
        self.btnGetPlatformNodeIdFromPrivate.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.btnGetPlatformNodeIdFromPrivate.setObjectName("btnGetPlatformNodeIdFromPrivate")
        self.horizontalLayout_11.addWidget(self.btnGetPlatformNodeIdFromPrivate)
        self.verticalLayout.addLayout(self.horizontalLayout_11)
        self.horizontalLayout_13 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_13.setObjectName("horizontalLayout_13")
        self.lblPlatformP2PPort = QtWidgets.QLabel(self.widget_2)
        self.lblPlatformP2PPort.setMinimumSize(QtCore.QSize(144, 0))
    ...
    def retranslateUi(self, WdgMasternodeDetails):
        ...
        self.lblPlatformNodeId.setText(_translate("WdgMasternodeDetails", "Platform Node ID"))
        self.btnCopyPlatformId.setToolTip(_translate("WdgMasternodeDetails", "Copy Platform Node ID to clipboard"))
        self.btnGetPlatformNodeIdFromPrivate.setToolTip(_translate("WdgMasternodeDetails", "Set Platform Node ID from Ed25519 private key"))
        self.btnGetPlatformNodeIdFromPrivate.setText(_translate("WdgMasternodeDetails", "Convert from private"))
