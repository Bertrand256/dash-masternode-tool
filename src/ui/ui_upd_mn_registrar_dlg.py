...
class Ui_UpdMnRegistrarDlg(object):
    def setupUi(self, UpdMnRegistrarDlg):
        ...
        UpdMnRegistrarDlg.resize(671, 400)
        ...
        self.layLegacyMode = QtWidgets.QHBoxLayout()
        self.layLegacyMode.setObjectName("layLegacyMode")
        self.gridLayout.addLayout(self.layLegacyMode, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.chbLegacyOperatorKey, 4, 0, 1, 1)
