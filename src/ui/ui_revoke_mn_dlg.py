...
class Ui_RevokeMnDlg(object):
    def setupUi(self, RevokeMnDlg):
        ...
        self.btnCopyCommandText = QtWidgets.QToolButton(RevokeMnDlg)
    ...
    def retranslateUi(self, RevokeMnDlg):
        ...
        self.btnCopyCommandText.setToolTip(_translate("RevokeMnDlg", "Copy the command text for manual execution"))
