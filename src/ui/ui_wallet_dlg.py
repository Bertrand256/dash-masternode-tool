...
class Ui_WalletDlg(object):
    def setupUi(self, WalletDlg):
        ...
        self.vlayoutViewMode = QtWidgets.QVBoxLayout(self.widget_2)
        ...
        self.btnModeSettings = QtWidgets.QToolButton(self.widget_2)
        self.btnModeSettings.setObjectName("btnModeSettings")
        self.horizontalLayout.addWidget(self.btnModeSettings)
    ...
    def retranslateUi(self, WalletDlg):
        ...
        self.btnModeSettings.setToolTip(_translate("WalletDlg", "Settings"))
        self.btnModeSettings.setText(_translate("WalletDlg", "..."))
