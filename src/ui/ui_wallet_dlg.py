...
class Ui_WalletDlg(object):
    def setupUi(self, WalletDlg):
        ...
        self.btnSelectUtxos = QtWidgets.QToolButton(self.main_widget)
        self.btnSelectUtxos.setToolTip("")
        self.btnSelectUtxos.setIconSize(QtCore.QSize(12, 12))
        self.btnSelectUtxos.setPopupMode(QtWidgets.QToolButton.InstantPopup)
        self.btnSelectUtxos.setToolButtonStyle(QtCore.Qt.ToolButtonTextBesideIcon)
        self.btnSelectUtxos.setObjectName("btnSelectUtxos")
        self.horizontalLayout_4.addWidget(self.btnSelectUtxos)
    ...
    def retranslateUi(self, WalletDlg):
        ...
        self.btnSelectUtxos.setText(_translate("WalletDlg", "Select..."))
