...
class Ui_WalletDlg(object):
    def setupUi(self, WalletDlg):
        ...
        self.viewMasternodes = QtWidgets.QTableView(self.page_2)
        ...
        self.viewMasternodes.horizontalHeader().setVisible(False)
        self.viewMasternodes.horizontalHeader().setStretchLastSection(True)
        self.viewMasternodes.verticalHeader().setVisible(False)
        self.verticalLayout_10.addWidget(self.viewMasternodes)
