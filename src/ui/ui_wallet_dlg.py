...
class Ui_WalletDlg(object):
    def setupUi(self, WalletDlg):
        ...
        self.chbHideDust = QtWidgets.QCheckBox(self.main_widget)
        self.chbHideDust.setObjectName("chbHideDust")
        self.horizontalLayout_4.addWidget(self.chbHideDust)
    ...
    def retranslateUi(self, WalletDlg):
        ...
        self.chbHideCollateralTx.setText(_translate("WalletDlg", "Hide collateral"))
        self.chbHideDust.setText(_translate("WalletDlg", "Hide \"dust\""))
