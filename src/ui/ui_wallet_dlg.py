...
class Ui_WalletDlg(object):
    def setupUi(self, WalletDlg):
        ...
        self.htmlViewModeOptions = QtWidgets.QLabel(self.wdgLeftPanel)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.htmlViewModeOptions.sizePolicy().hasHeightForWidth())
        self.htmlViewModeOptions.setSizePolicy(sizePolicy)
        self.htmlViewModeOptions.setObjectName("htmlViewModeOptions")
        self.horizontalLayout.addWidget(self.htmlViewModeOptions)
    ...
    def retranslateUi(self, WalletDlg):
        ...
        self.htmlViewModeOptions.setToolTip(_translate("WalletDlg", "Options"))
        self.htmlViewModeOptions.setText(_translate("WalletDlg", "<a href=\"#test\"><img src=\"img/settings@16px.png\"></a>"))
