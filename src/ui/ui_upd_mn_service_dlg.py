...
class Ui_UpdMnServiceDlg(object):
    def setupUi(self, UpdMnServiceDlg):
        ...
        UpdMnServiceDlg.resize(688, 447)
        ...
        self.gridLayout.addLayout(self.layOperatorPayout, 3, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblPlatformP2PPort, 7, 0, 1, 1)
        self.lblPlatformNodeKeyMsg = QtWidgets.QLabel(self.page0)
        self.lblPlatformNodeKeyMsg.setObjectName("lblPlatformNodeKeyMsg")
        self.gridLayout.addWidget(self.lblPlatformNodeKeyMsg, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblOperatorPayout, 3, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblPlatformNodeKey, 5, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblOperatorPayoutMsg, 4, 1, 1, 1)
        self.lblPlatformPortsMsg = QtWidgets.QLabel(self.page0)
        self.lblPlatformPortsMsg.setObjectName("lblPlatformPortsMsg")
        self.gridLayout.addWidget(self.lblPlatformPortsMsg, 8, 1, 1, 1)
