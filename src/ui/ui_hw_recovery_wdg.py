...
class Ui_WdgRecoverHw(object):
    ...
    def retranslateUi(self, WdgRecoverHw):
        ...
        self.label_2.setText(_translate("WdgRecoverHw", "<b>The source of the recovery seed</b>"))
        self.rbSeedSourceHwScreen.setText(_translate("WdgRecoverHw", "Recover from seed words using the hardware wallet screen (secure)"))
        self.rbSeedSourceAppWords.setText(_translate("WdgRecoverHw", "Recover from seed words using the app editor (convenient but insecure)"))
        ...
        self.label.setText(_translate("WdgRecoverHw", "<b>The number of words for your recovery seed</b>"))
        ...
        self.lblStep1HexEntropy.setText(_translate("WdgRecoverHw", "<b>The hexadecimal entropy of the recovery seed</b>"))
        ...
        self.lblDeviceWordsInputType.setText(_translate("WdgRecoverHw", "Words input on device"))
