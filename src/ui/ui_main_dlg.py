...
"padding-right: 0px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "Znode"))
        self.cboMasternodes.setToolTip(_translate("MainWindow", "List of configured Znode"))
        self.btnMoveMnUp.setToolTip(_translate("MainWindow", "Move up in the Znode list"))
        self.btnMoveMnDown.setToolTip(_translate("MainWindow", "Move down in the Znode list"))
        ...
        self.lblMasternodeStatus.setText(_translate("MainWindow", "Znode status"))
        ...
        self.btnRegisterDmn.setToolTip(_translate("MainWindow", "Register new/update existing Znode by sending a ProRegTx transaction."))
        self.btnRegisterDmn.setText(_translate("MainWindow", "Register Znode"))
        self.btnUpdMnPayoutAddr.setToolTip(_translate("MainWindow", "Update the Znode payout address on the network."))
        self.btnUpdMnPayoutAddr.setText(_translate("MainWindow", "Update payout addr."))
        self.btnUpdMnOperatorKey.setToolTip(_translate("MainWindow", "Update the Znode operator key on the network."))
        self.btnUpdMnOperatorKey.setText(_translate("MainWindow", "Update operator key"))
        self.btnUpdMnVotingKey.setToolTip(_translate("MainWindow", "Update the Znode voting key on the network."))
        self.btnUpdMnVotingKey.setText(_translate("MainWindow", "Update voting key"))
        self.btnUpdMnService.setToolTip(_translate("MainWindow", "Update the Znode IP:port and/or the operator reward Zcoin address."))
        self.btnUpdMnService.setText(_translate("MainWindow", "Update service"))
        self.btnRevokeMn.setToolTip(_translate("MainWindow", "Revoke the Znode operator key."))
