...
class Ui_SendPayoutDlg(object):
    def setupUi(self, SendPayoutDlg):
        ...
        self.lbl_message = QtWidgets.QLabel(SendPayoutDlg)
        ...
        self.lbl_message_2 = QtWidgets.QLabel(SendPayoutDlg)
        ...
        self.layStatusBar.addItem(spacerItem5)
    ...
    def retranslateUi(self, SendPayoutDlg):
        ...
        self.btnUtxoViewColumns.setText(_translate("SendPayoutDlg", "Columns..."))
