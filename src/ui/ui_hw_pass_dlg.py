...
# Form implementation generated from reading ui file '/Users/blogin/Projects/dash-masternode-tool/src/ui/ui_hw_pass_dlg.ui'
#
...
class Ui_HardwareWalletPassDlg(object):
    def setupUi(self, HardwareWalletPassDlg):
        ...
        HardwareWalletPassDlg.resize(450, 106)
        ...
        self.btnEnterOnDevice = QtWidgets.QPushButton(HardwareWalletPassDlg)
        self.btnEnterOnDevice.setMinimumSize(QtCore.QSize(150, 0))
        self.btnEnterOnDevice.setObjectName("btnEnterOnDevice")
        self.horizontalLayout.addWidget(self.btnEnterOnDevice)
