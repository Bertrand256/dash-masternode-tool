...
# Form implementation generated from reading ui file '/Users/blogin/PycharmProjects/DMT-git/src/ui/ui_conn_rpc_wdg.ui'
#
...
class Ui_RpcConnection(object):
    def setupUi(self, RpcConnection):
        ...
        self.horizontalLayout.addWidget(self.lblRpcPort)
        ...
        self.gridLayout.addWidget(self.lblRpcUsername, 1, 0, 1, 1)
        self.edtRpcUsername = QtWidgets.QLineEdit(RpcConnection)
        self.edtRpcUsername.setObjectName("edtRpcUsername")
        self.gridLayout.addWidget(self.edtRpcUsername, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lblRpcPassword, 2, 0, 1, 1)
        self.chbRpcSSL = QtWidgets.QCheckBox(RpcConnection)
        self.chbRpcSSL.setObjectName("chbRpcSSL")
        self.gridLayout.addWidget(self.chbRpcSSL, 3, 0, 1, 2)
    ...
    def retranslateUi(self, RpcConnection):
        ...
        self.lblRpcPort.setText(_translate("RpcConnection", "port:"))
