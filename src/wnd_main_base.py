...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btnReadAddressFromTrezor = QtWidgets.QPushButton(self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.btnReadAddressFromTrezor.sizePolicy().hasHeightForWidth())
        self.btnReadAddressFromTrezor.setSizePolicy(sizePolicy)
        self.btnReadAddressFromTrezor.setMinimumSize(QtCore.QSize(30, 24))
        self.btnReadAddressFromTrezor.setMaximumSize(QtCore.QSize(30, 24))
        self.btnReadAddressFromTrezor.setObjectName("btnReadAddressFromTrezor")
        self.horizontalLayout_2.addWidget(self.btnReadAddressFromTrezor, 0, QtCore.Qt.AlignVCenter)
        ...
        self.gridLayout.addWidget(self.lblConnectionStatus, 1, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edtMnCollateralBip32Path.setToolTip(_translate("MainWindow", "BIP32 path of the 1000 Dash collateral"))
        self.edtMnCollateralBip32Path.setPlaceholderText(_translate("MainWindow", "BIP32 path"))
        self.btnReadAddressFromTrezor.setToolTip(_translate("MainWindow", "Convert BIP32 path to Dash address using Trezor"))
        self.btnReadAddressFromTrezor.setText(_translate("MainWindow", "->"))
        self.edtMnCollateralAddress.setToolTip(_translate("MainWindow", "Dash address of the 1000 Dash collateral, coverted from BIP32 path with Trezor."))
        ...
        self.btnBroadcastMn.setText(_translate("MainWindow", "Start Masternode using Trezor"))
        self.groupBox.setTitle(_translate("MainWindow", "Dash network connection"))
