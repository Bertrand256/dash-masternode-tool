...
add_files = [
 ('arrow-bottom.png','/img'),
 ('arrow-down.png','/img'),
 ('arrow-right.ico','/img'),
 ('arrow-top.png','/img'),
 ('arrow-up.png','/img'),
 ('autorenew@16px.png','/img'),
 ('check.png','/img'),
 ('delete@16px.png','/img'),
 ('dmt.icns','/img'),
 ('dmt.ico','/img'),
 ...
 ('gear.png','/img'),
 ('hw.png','/img'),
 ('hw-disconnect.png','/img'),
 ('hw-test.png','/img'),
 ('info.png','/img'),
 ('label@16px.png','/img'),
 ('link-check.png','/img'),
 ('money-bag.png','/img'),
 ('money-transfer-1.png','/img'),
 ('money-transfer-2.png','/img'),
 ('recover.png','/img'),
 ('save.png','/img'),
 ('settings@16px.png','/img'),
 ('sign.png','/img'),
 ('thumbs-up-down.png','/img'),
 ('uncheck.png','/img'),
 ('wallet.png','/img')
 ('version.txt', '')
]
